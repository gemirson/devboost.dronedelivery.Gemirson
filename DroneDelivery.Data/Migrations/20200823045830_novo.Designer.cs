...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DroneDelivery.Domain.Entidades.Intinerario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<double>("AutonomiaAtual")
                        .HasColumnType("float");

                    b.Property<Guid>("IdDrone")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DroneDelivery.Domain.Entidades.Pedido", b =>
                {
                    b.HasOne("DroneDelivery.Domain.Entidades.Drone", "Drone")
                        .WithOne("Pedido")
                        .HasForeignKey("DroneDelivery.Domain.Entidades.Pedido", "DroneId");
                });
